...
<header class="header">
    ...
    <div class="header_content d-flex flex-row align-items-center justify-content-start">
        <div class="logo"><a href="{{url('/')}}"> 
            {{-- Property<i><span>Consultant</span></i>  --}}
        <img src="{{ asset('assets/image.png') }}" style="max-width: 64%; color: black;" />
        </a></div>
        ...
        <nav class="main_nav">
            <ul class="d-flex flex-row align-items-start justify-content-start">
                ...
                @if(Auth::check())
                    <li class="@if(Request::route()->getName() == 'ServiceProviderServices') active @endif">
